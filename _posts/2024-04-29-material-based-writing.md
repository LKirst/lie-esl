...
1. Introduction, which leads to a paraphrase of the essay question
2. Main body, in which you present your arguments or views to answer the
   question
...
If a material contains several numbers, **do not cherry-pick just one**. Make
sure you use the material in a way that shows you have understood the
**relationships or developments** it presents.
...
If the material is **a cartoon or a picture**, **use its main idea** as the
basis of an argument (or as the hook for your introduction) as if it were your
idea. Sometimes, the cartoon or picture may also contain an example you should
...
As for E11 SA1 (see above), I do not recommend using either material's main
idea in the introduction. Typically, each material will give you the idea for
one of your body paragraphs. It is sometimes possible to use part of a material
for the essay hook if the material contains several pieces of information.
...
your own ideas. Just ensure that each body paragraph contains a clear topic
